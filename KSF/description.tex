...
\KSF{I think it's odd that the reader doesn't know what we're proposing even broadly until the 3rd paragraph. Consider adding general ``thesis'' sentence at end of 1st / beginning of 2nd?}
...
\textbf{departures from predictions}. \KSF{Do we need the qualifier ``in our view,'' and others elsewhere?}
...
The first axis is \emph{volume}: We need to observe more volume. 
...
Upcoming wide-field surveys include DESI \citep{Aghamousa2016}, which will begin taking data in 2019, followed by NASA's Euclid mission \citep{Amiaux2012} and LSST \citep{Ivezic2018} in 2021, and WFIRST in the mid-2020s \citep{Spergel2015}.
