...
First, choosing the number of bins requires a trade-off between bias and variance.
...
\KSF{I'm not sure if Intellectual Merit is the place for examples - would say cut, but does make it less concrete}
...
\KSF{Propose cutting, address in text enough, and don't want to confuse reader}
...
%\KSF{Propose cutting this, answered in text}
