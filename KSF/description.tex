...
\pagestyle{fancy}
\newcommand{\thistitle}{\acronym{CDS\&E}: Creating new opportunities for precision and discovery in cosmology experiments}
...
expansion history and the growth of structure. \KSF{How do we know this observationally when we don't have the observations?}
...
The first axis is \emph{volume}: We need to observe more spatial volume. 
